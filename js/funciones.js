...
function Click_Card(Id_noticias){
    IDNoticias=Id_noticias;
...
/*    }*/
    ...
    if (this.tipo=="T3"){
        ...
        var noticia_id=this.ID;
        ObjTarjeta.addEventListener("click", function() {Click_Card(noticia_id)});
